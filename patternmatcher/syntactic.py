...
def get_symbol_wildcard(state, symbol_type):
                ...
                try:
                    try:
                        ...
                        if isinstance(key, Symbol):
                            symbol_wildcard_key = get_symbol_wildcard(state, key)
                            if symbol_wildcard_key is not None:
                                return state[get_symbol_wildcard(state, key)], False
                ...
                try:
                    try:
                        ...
                        if is_operation(term):
                            ...
                            symbol_wildcard_key = get_symbol_wildcard(state, term)
